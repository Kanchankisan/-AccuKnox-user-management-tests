...
public class demo {
	...
	public void doLoginWithInvalidCredential() throws InterruptedException
	{
		//find username and enter username "Admin"
		 driver.findElement(By.xpath("//input[@placeholder='Username']")).sendKeys("admin123");
...
*/
	...
	public void searchEmployeeNyName() throws InterruptedException
	{
		...
		driver.findElements(By.xpath("(//input[@placeholder='Type for hints...'])[1]")).get(1).sendKeys("kanchan");
